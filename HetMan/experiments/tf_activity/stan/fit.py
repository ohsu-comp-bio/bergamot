...
# todo: adapt for bash command: python HetMan/experiments/tfactivity/stan/fit.py \
# todo:     $TEMPDIR $cohort $classif $cv_id $task_id
...
def main(argv):
    ...
    # TODO: make use of output_dir as in subvariant_detection/
    out_dir = argv[0]
    cohort = argv[1]
    ...
    # loads the list of genes to predict the proteomic levels of and the learning pipeline
