...
#SBATCH --job-name=pair-isolate_fit
...
#SBATCH --output=/home/exacloud/lustre1/CompBio/mgrzad/slurm/log-files/pair-isolate_fit_out-%A.txt
#SBATCH --error=/home/exacloud/lustre1/CompBio/mgrzad/slurm/log-files/pair-isolate_fit_err-%A.txt
#SBATCH --verbose
...
SETUP_DIR=$BASEDIR/setup/${cohort}/${gene1}_${gene2}
