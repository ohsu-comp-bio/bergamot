...
def main():
    ...
    parser.add_argument(
        '--freq_cutoff', type=int, default=25,
        help='sub-type sample frequency threshold'
        )
    parser.add_argument(
        '--max_genes', type=int, default=40,
    ...
    if args.verbose:
        print("Looking for mutation sub-types in cohort {} with at least {} "
              "samples in total.\n".format(args.cohort, args.freq_cutoff))
